...
async def queue_dsa_bite_for_telegram(background_tasks: BackgroundTasks):
    background_tasks.add_task(_generate_and_send_dsa_bite)
...
async def queue_cp_bite_for_telegram(
    ...
    background_tasks.add_task(_generate_and_send_cp_bite, request.category if request else None)
...
async def queue_my_problem_bite_for_telegram(background_tasks: BackgroundTasks):
    background_tasks.add_task(_generate_and_send_my_problem_bite)
